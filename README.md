...
| :---: | :---: |
| <img src="https://via.placeholder.com/400x250?text=Play+Together" width="400" /> | <img src="https://via.placeholder.com/400x250?text=PvP+Battle" width="400" /> |
...
```Lỗi này xảy ra do **thiếu các dòng trống (xuống dòng)** giữa các đoạn văn, tiêu đề và danh sách. Trong Markdown, nếu bạn dính liền mọi thứ mà không có dòng trắng ngăn cách, nó sẽ hiển thị thành một khối văn bản dài ngoằng như bạn thấy.

Dưới đây là bản **Raw Markdown** chuẩn đã được căn chỉnh lại. Bạn hãy bấm nút **Copy** ở góc phải khung mã bên dưới và dán đè (paste) vào file `README.md` của bạn nhé:
